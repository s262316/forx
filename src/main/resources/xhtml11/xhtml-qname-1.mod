...
<!-- XHTML Qname (Qualified Name) Module
     ...
     This module is contained in two parts, labeled Section 'A' and 'B':
       ...
       Section A declares parameter entities to com.github.s262316.forx.support namespace-
...
<!-- This is a placeholder for future XLink com.github.s262316.forx.support.
-->
