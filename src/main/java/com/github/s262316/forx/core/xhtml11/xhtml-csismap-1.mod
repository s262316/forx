...
<!-- Client-side Image Maps
     ...
     This module declares elements and attributes to com.github.s262316.forx.support client-side
...
<!-- 'usemap' points to the 'id' attribute of a <map> element,
     which must be in the same document; com.github.s262316.forx.support for external
