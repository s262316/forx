...
public class TestEventDispatcher
{
	...
	public void testAllKindsUniqueListenerForEach()
	{
		...
		verify(event1Listener, times(3)).handle(event1);
		eventDispatcher1.fire(node1, event2);
		verify(event2Listener, times(3)).handle(event2);
		eventDispatcher1.fire(node1, event3);
		verify(event3Listener, times(3)).handle(event3);
		eventDispatcher1.fire(node2, event1);
		verify(event1Listener, times(6)).handle(event1);
		eventDispatcher1.fire(node2, event2);
		verify(event2Listener, times(6)).handle(event2);
		eventDispatcher1.fire(node2, event3);
		verify(event3Listener, times(6)).handle(event3);
		eventDispatcher1.fire(node3, event1);
		verify(event1Listener, times(9)).handle(event1);
		eventDispatcher1.fire(node3, event2);
		verify(event2Listener, times(9)).handle(event2);
		eventDispatcher1.fire(node3, event3);
		verify(event3Listener, times(9)).handle(event3);
	}
	...
	public void testMultipleListenersInstalled()
	{
		...
		verify(event1Listener, times(1)).handle(event1);
		verify(event2Listener, times(1)).handle(event1);
	}
	...
	public void testJustBubble()
	{
		...
		verify(event1Listener, times(1)).handle(event3);
	}
	...
	public void testJustCaputre()
	{
		...
		verify(event2Listener, times(1)).handle(event3);
	}
	...
	public void testJustOnTarget()
	{
		...
		verify(event3Listener, times(1)).handle(event3);
	}
}
